# Database Layer 1 - SaaS Business Layer
...
-- Layer 1: SaaS Business Layer (REVISED & SECURED) - PART 1
...
CREATE TABLE tenant_wallets (
 ...
 balance NUMERIC(20,4) NOT NULL DEFAULT 0, -- ارتقا به نوع داده دقیق مالی
...
-- 8. plan_version_features (اصلاح نام‌گذاری بر اساس اصل ۱۱ و حذف کلمه ممنوعه pivot)
...
-- Layer 1: SaaS Business Layer (REVISED & SECURED) - PART 2
...
-- اصلاح معماری: حذف فیلدهای آلوده هویتی و اتصال منطقی بر اساس اهداف DDD به لایه ۴
...
CREATE TABLE invoice_profiles (
 ...
 billing_partner_id UUID NOT NULL, -- ارجاع منطقی به جدول bp_partners در لایه ۴ بدون FK فیزیکی
